...
$Kaue = "Kauê Xavier Cardoso";
$arrayKaue = explode(" ", $Kaue);
...
<pre> <?=var_dump($Kaue)?></pre>
<pre> <?=var_dump($arrayKaue)?></pre>
...
<?php
    $bandas = ["Savages", "Nightwish", "Ghost"];
...
<?php
    ...
    if(password_veirfy($senhaDigitada,$senhaSegura)) {
